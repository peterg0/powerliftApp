...
namespace Powerliftprototype
{
	partial class Form3MesocycleView
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.userControlMesoView1.currentUser = null;
			this.userControlMesoView1.currentUser_Mesocycle = null;
			...
			this.userControlMesoView1.Load += new System.EventHandler(this.userControlMesoView1_Load);
			// 
			// Form3MesocycleView
			// 
